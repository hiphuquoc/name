<div class="shareSocialBox">
    ...
    <div class="shareSocialBox_item">
        <a href="https://www.facebook.com/sharer.php?u={{ URL::current() }}" class="shareSocialBox_item_icon facebook" target="_blank" rel="nofollow"></a>
    </div>
    <div class="shareSocialBox_item">
        <a href="https://twitter.com/intent/tweet?url={{ URL::current() }}" class="shareSocialBox_item_icon twitter" target="_blank" rel="nofollow"></a>
    </div>
    {{-- <div class="shareSocialBox_item">
