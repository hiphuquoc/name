...
<div class="formBox_full_item">
    ...
    ">
        ...
        <label class="form-label inputRequired" for="image">Ảnh đại diện <span style="font-weight:700;">{{ config('image.resize_normal_width') }}*{{ config('image.resize_normal_height') }} px</span></label>
    </span>
