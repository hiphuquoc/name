...
<div class="titlePage">Danh Sách Category còn thiếu ngôn ngữ</div>

@include('admin.category.searchLanguageNotExists', compact('list'))
        ...
        <table class="table table-bordered" style="min-width:900px;">
            ...
            <tbody>
                @if(!empty($list)&&$list->isNotEmpty())
                    ...
                    @endforeach
                @else
                    <tr><td colspan="5">Tuyệt vời, tất cả Category đã đủ ngôn ngữ!</td></tr>
                @endif
            </tbody>
        </table>
    </div>
