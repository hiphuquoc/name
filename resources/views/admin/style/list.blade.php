...
<div class="titlePage">Danh sách Phong cách</div>

@include('admin.style.search', compact('list'))
...
<!-- Nút thêm -->
<a href="{{ route('admin.style.view') }}" class="addItemBox">
