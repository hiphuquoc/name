...
@section('content')
    ...
    @php
        $titlePage      = 'Thêm Style mới';
        $submit         = 'admin.style.create';
        $checkImage     = 'required';
        if(!empty($type)&&$type=='edit'){
            $titlePage  = 'Chỉnh sửa Style';
            $submit     = 'admin.style.update';
            $checkImage = null;
        }
    @endphp
            ...
            <div class="pageAdminWithRightSidebar_main">
                ...
                <div class="pageAdminWithRightSidebar_main_rightSidebar">
                    ...
                    <div class="pageAdminWithRightSidebar_main_rightSidebar_item buttonAction" style="padding-bottom:1rem;">
                        <a href="{{ route('admin.style.list') }}" type="button" class="btn btn-secondary waves-effect waves-float waves-light">Quay lại</a>
