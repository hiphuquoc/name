                ...
                foreach($infoPage->seos as $seo){
                    if(!empty($seo->infoSeo->language)&&$seo->infoSeo->language==$this->language){
                        ...
                        $promptText     = 'tôi có một danh mục hình nền điện thoại, gồm title, seo_title và seo_description. Thông tin bản gốc tiếng việt và tiếng anh như bên dưới:
                                            ...
                                            Ghi chú quan trọng: nếu là tên riêng (ví dụ: tên một bộ phim, tên nhân vật, tên thương hiệu,...) và ngôn ngữ này không có bản dich chính xác, không có cách gọi thông dụng của ngôn ngữ địa phương cho title đó thì hãy tham khảo title tiếng anh và wiki để lấy title cho đúng, ghép vào title vào seo_title, seo_description dịch ra ngôn ngữ này bình thường.
